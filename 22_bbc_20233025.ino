...
#define _DUTY_MAX 2642 // 2000
#define _DUTY_NEU 2035 // 1500
#define _DUTY_MIN 1421 // 1000
...
float volt_to_distance(int a_value)
{
  ...
  return 591 + -3.48*a_value + 7.9E-03*a_value*a_value + -6.17E-06*a_value*a_value*a_value   ;
}
